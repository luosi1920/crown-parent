...
public class FacePlusMultipartForm {
     ...
     */
    private FacePlusMultipartForm(final Charset charset, final String boundary) {
        super();
    ...
    public FacePlusMultipartForm(
            final Charset charset,
            final String boundary,
            final List<FormBodyPart> parts) {
        this(charset, boundary);
        this.parts = parts;
    }

    public FacePlusMultipartForm(final String boundary) {
        this(null, boundary);
    }
     ...
     */
    public void formatMultipartHeader(
